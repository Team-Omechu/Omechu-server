      ...
      time = timePart
        ...
        .replace(
          ...
          (match, h1, m1, h2, m2) => {
            ...
            return `${startHour.toString().padStart(2, "0")}:${m1} - ${endHour
              .toString()
              .padStart(2, "0")}:${m2}`;
          }
        );
...
export const responseFromGetRestData = (data) => {
  ...
  const currentOpeningHours = [
    { days_of_the_week: "월", time: data.monday },
    { days_of_the_week: "화", time: data.tuesday },
    { days_of_the_week: "수", time: data.wednesday },
    { days_of_the_week: "목", time: data.thursday },
    { days_of_the_week: "금", time: data.friday },
    { days_of_the_week: "토", time: data.saturday },
    { days_of_the_week: "일", time: data.sunday },
  ];
